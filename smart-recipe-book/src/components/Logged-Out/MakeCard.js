    ...
    return (
        <div>
            <Card elevation={12} sx={{height: "450px", width: "80%", marginLeft: "5%", marginTop: "10%", padding: "1%"}}>
                ...
                <Button onClick={ViewMoreClick} sx={{color: "#5e89b4b7", justifyContent: "center", fontWeight: "bold", position: "relative", bottom: "-110px"}} data-testid="card-button">View recipe</Button>
                </Box>
            </Card>
        </div>
    );
